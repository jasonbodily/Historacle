...
class AreasControllerTest < ActionController::TestCase
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post :create, area: { coordinates: @area.coordinates, end_date: @area.end_date, name: @area.name, start_date: @area.start_date }
    end
  ...
  test "should update area" do
    put :update, id: @area, area: { coordinates: @area.coordinates, end_date: @area.end_date, name: @area.name, start_date: @area.start_date }
    assert_redirected_to area_path(assigns(:area))
  end
